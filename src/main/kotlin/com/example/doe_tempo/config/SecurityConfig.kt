...
import com.example.doe_tempo.security.jwt.JwtConfigurer
import com.example.doe_tempo.security.jwt.JwtTokenProvider
...
class SecurityConfig {
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        return http
            ...
            .cors().and().apply(JwtConfigurer(tokenProvider))
            .and().build()
    }
}